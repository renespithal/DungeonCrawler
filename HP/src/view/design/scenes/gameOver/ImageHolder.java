...
//    Image backgroundGW = new Image((getClass().getResource("/images/gameWonBackground.png").toExternalForm()), 1920, 1080, true, true);
  //  ImagePattern backgroundGWPattern = new ImagePattern(backgroundGW);
    ...
    Image moveButtonSelected = new Image((getClass().getResource("/images/MoveSelected.png").toExternalForm()), 80,80,true,true);
    ImagePattern moveButtonSelectedPattern = new ImagePattern(moveButtonSelected);
    Image useButtonSelected = new Image((getClass().getResource("/images/UseSelected.png").toExternalForm()), 80,80,true,true);
